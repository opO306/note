...
export function BottomNavigation({
  ...
  return (
    <nav className="bg-card/98 glass-effect border-t border-border flex-shrink-0 shadow-[0_-2px_8px_rgba(0,0,0,0.04)] dark:shadow-[0_-2px_8px_rgba(0,0,0,0.2)] safe-nav-bottom">
      <div className="px-2 py-2">
        <div className="flex items-center justify-around max-w-md mx-auto">
          ...
          {onWriteClick && (
            <Button
              className="write-button rounded-full w-14 h-14 bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl relative overflow-hidden"
