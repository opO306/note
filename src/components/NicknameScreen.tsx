...
import { auth, functions } from "../firebase"; // 👈 db 제거, functions 추가
import { httpsCallable } from "firebase/functions";
import { updateProfile } from "firebase/auth";

// 1. 누락되었던 cursiveSymbols 배열 복구
...
// 2. 누락되었던 FloatingSymbolItem 컴포넌트 복구
